...
1. **Download** `SuYan-Setup-0.1.0.exe`, or use portable `素言.exe` from the ZIP  
   (Free software; prefer [GitHub Releases](https://github.com/guliacer/SuYan/releases). Report paid resellers via [Issues](https://github.com/guliacer/SuYan/issues).)
