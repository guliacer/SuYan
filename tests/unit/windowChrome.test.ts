...
describe("window chrome contract", () => {
  it("gives window controls to the renderer instead of native overlay controls", () => {
    ...
    expect(tokenSource).toContain("--color-chrome-start: #f3f3f4");
    expect(tokenSource).toContain("--color-chrome-underlay: #ffffff");
    expect(tokenSource).toContain("--color-primary: #ff6363");
    ...
    expect(bootstrapSource).toContain("data-theme-preset=\"raycast\"");
    expect(bootstrapSource).toContain("--app-loading-chrome-start: #f3f3f4");
    ...
    expect(statusToastSource).toContain("top-[calc(var(--app-window-content-top)+0.75rem)]");
    expect(statusToastSource).toContain("z-[9990]");
