...
每个模块先列能力，再配操作步骤与演示动图，按日常使用顺序阅读即可。
...
1. 打开应用，中间瀑布流浏览全部素材
2. 顶部搜索标题、文件名、提示词或标签
3. 用分类 / 标签 / 精选筛选，或切换排序方式
4. 点进卡片进入详情，对照编辑、复制或分享
...
2. 在文件对话框里多选本机图片
3. 确认后自动入库，瀑布流出现缩略图
4. 也可直接粘贴剪切板图片，或导入 Word 中的图文提示词
...
1. **导出：** 详情页点「分享」，或在「批量管理」勾选多组后导出 ZIP
2. 包内含效果图与对应提示词，换电脑、换人都能传
...
1. 进入「批量管理」，查看各组数量与标签概况
2. **去重：** 扫描重复图，确认后保留一份、清理多余
