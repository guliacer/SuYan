...
从 [GitHub Releases](https://github.com/guliacer/SuYan/releases) 下载当前可用版本的安装包或便携版。当前正式版为 `v0.3.7`，GitHub 上的最新版本以 Releases 页面为准。

`v0.3.7` 提供四种 Windows 包：便携版或安装版，以及不含可选组件或含完整本地组件的版本。请按使用方式和是否需要离线媒体处理 / 内容分级选择，下载后使用随附的 `SHA256SUMS.txt` 校验文件完整性。
